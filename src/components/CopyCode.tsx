...
const CopyCode: React.FC<ICopyCodeProps> = ({ code, bgcolor }) => {
	...
	return (
		<button
			onClick={onCopy}
			className={`${copy ? 'active' : ''} product-info__articule ${bgcolor}`}
		>
			{copy ? <span>Код скопирован</span> : <span>Код товара: {code}</span>}
			<svg
				width='20'
				height='20'
				viewBox='0 0 20 20'
