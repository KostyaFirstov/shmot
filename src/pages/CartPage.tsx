...
const CartPage = () => {
	...
	return (
		<ContentLayout>
			{cartItems.length === 0 ? (
				<ErrorBlock title='Нет товаров :(' desc='В корзине нет товаров..' />
			) : (
				<>
					...
					<div className='cart__footer'>
						<div className='cart__footer-totalprice'>
							<h3>Итого: {totalPrice} ₽</h3>
						</div>
						<button className='button button-black'>Оформить заказ</button>
					</div>
				</>
			)}
		</ContentLayout>
